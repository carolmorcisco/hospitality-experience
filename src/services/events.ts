export const EVENTS = {
    ...
    ACTIVITIES_RECOMMENDED: 'activities.recommended',
  
    ACTIVITIES_WAIVER_SENT: 'activities.waiver.sent',
  
    ACTIVITIES_WAIVER_ACCEPTED: 'activities.waiver.accepted',
  
    ACTIVITIES_QR_GENERATED: 'activities.qr.generated',
